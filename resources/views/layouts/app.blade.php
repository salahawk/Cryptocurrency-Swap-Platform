            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li>
                                <a href="{{ route('register') }}" target="_blank" class="btn btn-info btn-rose btn-lg">
                                    <i class="material-icons">person_add</i> Register
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('login') }}" target="_blank" class="btn btn-info btn-info btn-lg">
